...
static unsigned int step_down = FREQ_STEP_DOWN;
#define FREQ_SLEEP_MAX 				(368640)
static unsigned int sleep_max = FREQ_SLEEP_MAX;
#define FREQ_AWAKE_MIN 				(24576)
static unsigned int awake_min = FREQ_AWAKE_MIN;
