...
#else
#ifdef CONFIG_SHSYS_CUST_MSMC2_1100_MV
	{ 1, 24576,  SRC_LPXO, 0, 0,  30720000,  1000, VDD_RAW(1000) },
	{ 1, 61440,  PLL_3,    5, 11, 61440000,  1000, VDD_RAW(1000) },
	{ 1, 122880, PLL_3,    5, 5,  61440000,  1000, VDD_RAW(1000) },
	{ 1, 184320, PLL_3,    5, 4,  61440000,  1000, VDD_RAW(1000) },
	{ 1, MAX_AXI_KHZ, SRC_AXI, 1, 0, 61440000, 1000, VDD_RAW(1000) },
	{ 1, 245760, PLL_3,    5, 2,  61440000,  1000, VDD_RAW(1000) },
	{ 1, 368640, PLL_3,    5, 1,  122800000, 1050, VDD_RAW(1050) },
	/* AXI has MSMC1 implications. See above. */
	{ 1, 460800, PLL_1,    2, 0,  153600000, 950, VDD_RAW(1050) },
	{ 1, 576000, PLL_1,    2, 0,  153600000, 1000, VDD_RAW(1050) },
	{ 1, 652800, PLL_1,    2, 0,  153600000, 1050, VDD_RAW(1100) },
	{ 1, 768000, PLL_1,    2, 0,  153600000, 1100, VDD_RAW(1100) },
#else  /* CONFIG_SHSYS_CUST_MSMC2_1100_MV */
